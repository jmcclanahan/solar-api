...
class StatesControllerTest < ActionController::TestCase
  ...
  test "should create state" do
    assert_difference('State.count') do
      post :create, state: { state_code: @state.state_code, state_desc: @state.state_desc }
    end
  ...
  test "should update state" do
    put :update, id: @state, state: { state_code: @state.state_code, state_desc: @state.state_desc }
    assert_response 204
  end
